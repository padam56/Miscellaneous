...
class DQModel(keras.Model):
    def __init__(self, hidden_size: int, num_actions: int, dueling: bool):
        ...
        self.conv1 = tf.keras.layers.Conv2D(16, (8, 8), (4, 4), padding="same",activation='relu',use_bias=False,input_shape=(32,num_actions))
        self.conv2 = tf.keras.layers.Conv2D(32, (4, 4), (2, 2), padding="same",activation='relu',use_bias=False,input_shape=(32,num_actions))
        self.conv3 = tf.keras.layers.Conv2D(64, (4, 4), (2, 2), padding="same",activation='relu',use_bias=False,input_shape=(32,num_actions))
        #self.conv4 = tf.keras.layers.Conv2D(32, (4, 4), (2, 2), padding="same",activation='relu',use_bias=False,input_shape=(32,num_actions))
        ...
        self.adv_outa = tf.keras.layers.Dense(num_actions,activation='relu',
                                          kernel_initializer=keras.initializers.he_normal(),input_shape=(32,num_actions))
